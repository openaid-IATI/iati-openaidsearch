...
$resolutions   = array(1440, 979, 767, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "wp-content/themes/unhabitat2/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
